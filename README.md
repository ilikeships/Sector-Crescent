...
All code for the content repository is licensed under a modified version of base [MIT](https://github.com/space-wizards/space-station-14/blob/master/LICENSE.TXT).
