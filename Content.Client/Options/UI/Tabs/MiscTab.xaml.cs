...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class MiscTab : Control
    {
        ...
        public MiscTab()
        {
            ...
            var hudLayout = _cfg.GetCVar(CrescentCVars.UILayout);
            var id = 0;
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            {
                _cfg.SetCVar(CrescentCVars.UILayout, opt);
            }
        ...
        private void UpdateApplyButton()
        {
            ...
            var isLayoutSame = HudLayoutOption.SelectedMetadata is string opt && opt == _cfg.GetCVar(CrescentCVars.UILayout);
