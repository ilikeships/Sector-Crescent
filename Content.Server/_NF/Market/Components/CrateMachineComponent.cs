...
public sealed partial class CrateMachineComponent: Component
{
    ...
    /// </summary>
    [NonSerialized]
    public float OpeningTime = 3.5f;

    /// <summary>
    /// How long the closing animation will play
    /// </summary>
    [NonSerialized]
    public float ClosingTime = 3.5f;

    /// <summary>
    /// Sounds played when the door is closing
    /// </summary>
    [ViewVariables]
    public SoundSpecifier? ClosingSound = new SoundPathSpecifier("/Audio/Machines/blastdoor_reversed-01.ogg");
