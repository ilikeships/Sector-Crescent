...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    [Dependency] private readonly TChatSystem _tChat = default!;
        ...
        )
    {
        ...
        switch (desiredType)
        {
            ...
            case InGameICChatType.Telepathic:
                _tChat.SendTelepathicChat(source, message, range == ChatTransmitRange.HideChat);
                break;
        }
    }
        ...
        )
    {
        ...
        if (playSound && announcementSound is not null)
        {
            _audio.PlayGlobal(_audio.GetSound(announcementSound) ?? DefaultAnnouncementSound, Filter.Broadcast(), true, AudioParams.Default.WithVolume(-2f));
        }
        ...
        Color? colorOverride = null)
    {
        ...
        if (playDefaultSound && announcementSound is not null)
        {
            _audio.PlayGlobal(_audio.GetSound(announcementSound) ?? DefaultAnnouncementSound, filter, true, AudioParams.Default.WithVolume(-2f));
        }
